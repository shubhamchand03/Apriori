...
public class AprioriFrequentItemsetGenerator<I> {
	...
	public FrequentItemsetData generate(List<Set<I>> transactionList, double minimumSupport) {
		...
		return new FrequentItemsetData<>(extractFrequentItemsets(map), supportCountMap, minimumSupport,
	...
	private List<Set<I>> findFrequentItems(List<Set<I>> itemsetList, Map<Set<I>, Integer> supportCountMap,
